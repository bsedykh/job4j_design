...
public interface Menu extends Iterable<Menu.MenuItemInfo> {
    ...
    class MenuItemInfo {
        ...
        public MenuItemInfo(MenuItem menuItem, String number, int level) {
        ...
        public MenuItemInfo(String name, List<String> children, ActionDelegate actionDelegate, String number, int level) {
            this.name = name;
        ...
        @Override
        public int hashCode() {
            return Objects.hash(name, children, number, level);
        }
    }
}
