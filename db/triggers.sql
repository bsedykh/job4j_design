...
$$
    BEGIN
        insert into history_of_price(name, price, date) values(new.name, new.price * 1.1, current_date);
        return new;
    END;
$$
LANGUAGE 'plpgsql';
...
insert into products (name, producer, count, price) VALUES ('product', 'producer', 1, 100);
